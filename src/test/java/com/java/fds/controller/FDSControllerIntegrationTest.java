...
public class FDSControllerIntegrationTest{
    ...
    @Test
    public void givenRestaurent_whenGetRestaurents_thenReturnJsonArray()
      throws Exception {
        ...
        mvc.perform(get("/api/restaurents")
          .contentType(MediaType.APPLICATION_JSON))
          .andExpect(status().isOk())
          
          .andExpect(jsonPath("$[0].name", is(restaurent.getName())));
    }
